...
MODEL                = SeatHeaterapp
MODULES              = SeatHeaterapp.c SeatHeaterapp_capi.c 
MAKEFILE             = SeatHeaterapp.mk
...
MODELLIB                  = SeatHeaterapplib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SeatHeaterapp_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/SeatHeaterapp \
	-I$(START_DIR) \
