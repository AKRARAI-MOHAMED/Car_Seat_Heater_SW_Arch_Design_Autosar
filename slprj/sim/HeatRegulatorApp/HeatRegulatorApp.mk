...
MODEL                = HeatRegulatorApp
MODULES              = HeatRegulatorApp.c HeatRegulatorApp_capi.c 
MAKEFILE             = HeatRegulatorApp.mk
...
MODELLIB                  = HeatRegulatorApplib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = HeatRegulatorApp_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/HeatRegulatorApp \
	-I$(START_DIR) \
