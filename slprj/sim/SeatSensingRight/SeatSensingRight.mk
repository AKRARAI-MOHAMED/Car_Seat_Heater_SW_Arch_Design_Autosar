...
MODEL                = SeatSensingRight
MODULES              = SeatSensingRight.c SeatSensingRight_capi.c 
MAKEFILE             = SeatSensingRight.mk
...
MODELLIB                  = SeatSensingRightlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SeatSensingRight_ref.rsp
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/sim/SeatSensingRight \
	-I$(START_DIR) \
