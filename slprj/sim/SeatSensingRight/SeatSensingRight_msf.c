...
#define S_FUNCTION_NAME SeatSensingRight_msf
#endif
...
MdlRefChildMdlRec childModels [ 1 ] = { "SeatSensingRight" ,
"SeatSensingRight" , 1 } ; const char * rt_GetMatSignalLoggingFileName ( void
...
#endif
ssFcnCallErr_T pkikjs55ho_sf ( SimStruct * S , int_T el , int_T idx ) { const
boolean_T * i_a0uvxql1ip = ( boolean_T * ) ssGetInputPortSignal ( S , 1 ) ;
boolean_T * o_o_B_2_1 = ( boolean_T * ) ssGetOutputPortSignal ( S , 0 ) ;
pkikjs55ho ( i_a0uvxql1ip , o_o_B_2_1 ) ; return SS_FCNCALL_NO_ERR ; } static
...
, pkikjs55ho_sf ) ; { real_T minValue = rtMinusInf ; real_T maxValue = rtInf
...
mr_SeatSensingRight_RegisterSimStateChecksum ( S ) ; { static
...
false ) ; ssRegisterMsgForNotSupportingMultiExecInst ( S ,
 "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\"><arguments><arg type=\"encoded\">UwBlAGEAdABTAGUAbgBzAGkAbgBnAFIAaQBnAGgAdAAvAFMAZQBhAHQAUwBlAG4AcwBvAHIATQBhAGkAbgAAAA==</arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments></diag>\n</diag_root>"
...
mr_SeatSensingRight_MdlInfoRegFcn ( S , "SeatSensingRight" , & retVal ) ; if
( ! retVal ) return ; }
#endif
...
( S , & sysTid ) ; if ( sysTid == CONSTANT_TID ) { sysTid = 0 ; } er25btevih
( S , ssGetSampleTimeTaskID ( S , 0 ) , slmrGetParentTidFromExpFcnMdlChildTid
( S , 1 ) , sysRanPtr , sysTid , ( NULL ) , ( NULL ) , 0 , - 1 ) ;
ssSetModelMappingInfoPtr ( S , & ( jmyjvg0y0u . rtm . DataMapInfo . mmi ) ) ;
if ( S -> mdlInfo -> genericFcn != ( NULL ) ) { _GenericFcn fcn = S ->
mdlInfo -> genericFcn ; } d5tble1ktm ( o_o_B_2_1 ) ; } static void mdlOutputs
( SimStruct * S , int_T tid ) { if ( tid != CONSTANT_TID ) { SeatSensingRight
...
mxArray * mdlrefDW = mr_SeatSensingRight_GetDWork ( ) ; if ( NULL != mdlrefDW
...
( localX , & rawData [ 0 ] , numBytes ) ; } mr_SeatSensingRight_SetDWork (
